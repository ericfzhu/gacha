...
// Abyssal enemy ships
// Evasion kept very low so players can reliably hit enemies
export const ENEMIES = [
  // Destroyers (DD) - I-Class, Ro-Class, Ha-Class, Ni-Class
  { id: 'enemy_dd_i', name: 'Destroyer I-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 20, baseAtk: 15, baseDef: 8, baseSpd: 30, baseEva: 5, baseLuck: 10 },
  { id: 'enemy_dd_ro', name: 'Destroyer Ro-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 24, baseAtk: 18, baseDef: 10, baseSpd: 32, baseEva: 6, baseLuck: 12 },
  { id: 'enemy_dd_ha', name: 'Destroyer Ha-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 28, baseAtk: 22, baseDef: 12, baseSpd: 34, baseEva: 7, baseLuck: 14 },
  { id: 'enemy_dd_ni', name: 'Destroyer Ni-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 32, baseAtk: 26, baseDef: 14, baseSpd: 36, baseEva: 8, baseLuck: 16 },
