...
export const ENEMIES = [
  ...
  { id: 'enemy_dd_i', name: 'Destroyer I-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 20, baseAtk: 15, baseDef: 8, baseSpd: 30, baseEva: 40, baseLuck: 10 },
  { id: 'enemy_dd_ro', name: 'Destroyer Ro-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 24, baseAtk: 18, baseDef: 10, baseSpd: 32, baseEva: 42, baseLuck: 12 },
  { id: 'enemy_dd_ha', name: 'Destroyer Ha-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 28, baseAtk: 22, baseDef: 12, baseSpd: 34, baseEva: 44, baseLuck: 14 },
  { id: 'enemy_dd_ni', name: 'Destroyer Ni-Class', type: SHIP_TYPES.DESTROYER,
    baseHp: 32, baseAtk: 26, baseDef: 14, baseSpd: 36, baseEva: 48, baseLuck: 16 },
...
export function getEnemyStats(enemy, level = 1, variant = ENEMY_VARIANT.NORMAL) {
  // Simple linear scaling for enemies
  const levelMult = 1 + (level - 1) * 0.05;

  return {
    hp: Math.floor(enemy.baseHp * levelMult * variant.hpMult),
    atk: Math.floor(enemy.baseAtk * levelMult * variant.atkMult),
    def: Math.floor(enemy.baseDef * levelMult * variant.defMult),
    spd: enemy.baseSpd,
    eva: enemy.baseEva,
    luck: enemy.baseLuck,
